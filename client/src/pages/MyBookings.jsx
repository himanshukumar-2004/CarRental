      ...
      <div>
        {bookings.map((booking, index) => (
          <motion.div
            ...
            key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor dark:border-gray-700 rounded-lg mt-5 first:mt-12'>
            <div className='md:col-span-1'>
              <div className='rounded-md overflow-hidden mb-3'>
                <img src={booking.car.image} alt='' className='w-full h-auto aspect-video object-cover' />
              </div>

              <p className='text-lg font-medium mt-2 dark:text-gray-100'>{booking.car.brand} {booking.car.model}</p>
            ...
            <div className='md:col-span-2'>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  ...
                  <p className='dark:text-gray-200'>{formatDate(booking.pickupDate)} to {formatDate(booking.returnDate)}</p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  ...
                  <p className='dark:text-gray-200'>{booking.car.location}</p>
                </div>
              </div>
            </div>
            {/* Price*/}
