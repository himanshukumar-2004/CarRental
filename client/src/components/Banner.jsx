  ...
  return (
    ...
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        <div className='text-white'>
            ...
            <p className='max-w-130'>We take care of insurance, driver verification and secure payments-so you can earn passive
                income, stress-free.</p>
        ...
        <img src={assets.banner_car_image} alt="car" className='max-h-25 mt-10' /> 
