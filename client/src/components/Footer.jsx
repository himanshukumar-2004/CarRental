...
const Footer = () => {
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500 dark:text-gray-400'>
      ...
      className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor dark:border-gray-700 border-b'>
        <div>
          ...
          src={assets.logo} alt="logo" className='h-8 md:h-9 dark:brightness-0 dark:invert' />
          <motion.p 
              initial={{opacity: 0 }}
              whileInView={{opacity: 1 }}
              transition={{duration: 0.6, delay:0.4}}
          className='max-w-80 mt-3'>Premium car rental service with a wide
        ...
        <div>
         ...
         <div>
          ...
          <ul className='mt-3 flex flex-col gap-1.5'>
            ...
            <li>Patna, Bihar</li>
            <li>+91 9973761092</li>
            <li>himanshukr06092004@gmail.com</li>
          </ul>
        </div>
        </motion.div>
