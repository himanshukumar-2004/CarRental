...
const Hero = () => {
    ...
    return (
        <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
            ...
            <h1 className='text-4xl md:text-5xl font-semibold'>Luxury cars on Rent by himanshu pal</h1>
            angtod
         ...
         md:ml-8'>
                    ...
                    <div className='flex flex-col items-start gap-2'>
                        <select required value={pickupLocation} onChange={(e) => setPickupLocation(e.target.value)} className='px-4 py-2 rounded-lg border border-borderColor text-gray-500'>
